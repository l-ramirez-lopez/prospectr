...
package is very useful for signal processing and chemometrics in general as it 
...
package work indifferently for `data.frame`, `matrix` and `vector` inputs. 
...
high--throughput, non--destructive and cheap sensing methods that have a range of 
...
[special Volume in Spectroscopy and Chemometrics in R](https://www.jstatsoft.org/issue/view/v018) [@mullen2007] many spectroscopy-related packages have been released. Most of 
...
provides a list of Free Open Source Software (FOSS) dedicated to Spectroscopic 
...
difference method (difference between two subsequent data points), provided 
