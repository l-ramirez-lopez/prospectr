...
```{r movin, fig.cap = "Effect of a moving average with window size of 11 bands on a raw spectrum", tidy = TRUE, fig.height = 6, fig.width = 10, dpi = 50, out.height = "60%", out.width = "100%", fig.retina = 1}
# add some noise
...
```{r d1,fig.cap="Effect of first derivative and second derivative", fig.height=6,fig.width=10, tidy=TRUE, dpi = 50,out.height="60%",out.width="100%", fig.retina = 0.85}
# X = wavelength
# Y = spectral matrix
# n = order
...
```{r gapder,fig.cap="Effect of 1st-order gap derivative ", fig.height=6,fig.width=10, tidy=TRUE, dpi = 50,out.height="60%",out.width="100%", fig.retina = 0.85}
...
```{r gapseg,fig.cap="Effect of 1st-order gap-segment derivative ", fig.height=6,fig.width=10, tidy=TRUE, dpi = 50,out.height="60%",out.width="100%", fig.retina = 0.85}
...
```{r snv, eval=TRUE, fig.cap="Effect of SNV on raw spectra", fig.height=6,fig.width=10, tidy=TRUE, dpi = 50,out.height="60%",out.width="100%", fig.retina = 0.85}
...
```{r msc, fig.cap="Effect of MSC on raw spectra",fig.height=6,fig.width=10, tidy=TRUE, dpi = 50,out.height="60%",out.width="100%", fig.retina = 0.85}
...
```{r detrend, fig.cap="Effect of SNV-Detrend on raw spectra",fig.height=6,fig.width=10, tidy=TRUE, dpi = 50,out.height="60%",out.width="100%", fig.retina = 0.85}
# X = input spectral matrix
# wav = band centers
...
```{r cr, fig.cap = "Absorbance and continuum-removed absorbance spectra", fig.height = 6, fig.width = 10, tidy = TRUE, dpi = 50, out.height = "60%", out.width = "100%", fig.retina = 0.85}
...
```{r naes, fig.cap = "Selection of 5 samples by k-means sampling", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center', fig.retina = 0.85}
# X = the input matrix
...
```{r ken, fig.cap="Selection of 40 calibration samples with the Kennard-Stone algorithm", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center', fig.retina = 0.85}
...
```{r ken2, fig.cap="Kennard-Stone sampling on the NIRsoil dataset", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center', fig.retina = 0.85}
...
```{r duplex, fig.cap="Selection of 15 calibration and validation samples with the DUPLEX algorithm", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center', fig.retina = 0.85}
...
```{r shenk, fig.cap="Selection of samples with the SELECT algorithm", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center', fig.retina = 0.85}
...
```{r puchwein, fig.cap="Samples selected by the Puchwein algorithm", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center', fig.retina = 0.85}
...
```{r puchwein2, fig.cap="How to find the optimal loop", tidy=TRUE, dpi = 50, eval = FALSE, fig.retina = 0.85}
par(mfrow = c(2, 1))
...
```{r honigs, fig.cap="Spectra selected with the Honigs algorithm and bands used", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center', fig.retina = 0.85}
