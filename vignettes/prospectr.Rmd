...
- [Chemometrics and Computational Physics](http://cran.r-project.org/web/views/ChemPhys.html) 
...
```{r movin, fig.cap = "Effect of a moving average with window size of 11 bands on a raw spectrum", tidy = TRUE, fig.height = 6, fig.width = 10, dpi=300, out.height = "60%", out.width = "100%"}
# add some noise
...
```{r d1,fig.cap="Effect of first derivative and second derivative", fig.height=6,fig.width=10, tidy=TRUE, dpi = 300,out.height="60%",out.width="100%"}
# X = wavelength
# Y = spectral matrix
# n = order
...
```{r gapder,fig.cap="Effect of 1st-order gap derivative ", fig.height=6,fig.width=10, tidy=TRUE, dpi = 300,out.height="60%",out.width="100%"}
...
```{r gapseg,fig.cap="Effect of 1st-order gap-segment derivative ", fig.height=6,fig.width=10, tidy=TRUE, dpi = 300,out.height="60%",out.width="100%"}
...
```{r snv, eval=TRUE, fig.cap="Effect of SNV on raw spectra", fig.height=6,fig.width=10, tidy=TRUE, dpi = 300,out.height="60%",out.width="100%"}
...
```{r detrend, fig.cap="Effect of SNV-Detrend on raw spectra",fig.height=6,fig.width=10, tidy=TRUE, dpi = 300,out.height="60%",out.width="100%"}
...
```{r cr, fig.cap = "Absorbance and continuum-removed absorbance spectra", fig.height = 6, fig.width = 10, tidy = TRUE, dpi = 300, out.height = "60%", out.width = "100%"}
...
```{r naes, fig.cap = "Selection of 5 samples by k-means sampling", tidy = TRUE, dpi = 300, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'}
# X = the input matrix
...
```{r ken, fig.cap="Selection of 40 calibration samples with the Kennard-Stone algorithm", tidy = TRUE, dpi = 300, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'}
...
```{r ken2, fig.cap="Kennard-Stone sampling on the NIRsoil dataset", tidy = TRUE, dpi = 300, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'}
...
```{r duplex, fig.cap="Selection of 15 calibration and validation samples with the DUPLEX algorithm", tidy = TRUE, dpi = 300, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'}
...
```{r shenk, fig.cap="Selection of samples with the SELECT algorithm", tidy = TRUE, dpi = 300, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'}
...
```{r puchwein, fig.cap="Samples selected by the Puchwein algorithm", tidy = TRUE, dpi = 300, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'}
...
```{r honigs, fig.cap="Spectra selected with the Honigs algorithm and bands used", tidy = TRUE, dpi = 300, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'}
