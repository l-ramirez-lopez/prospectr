...
#' Nt (Total Nitrogen), Ciso (Carbon),
#' CEC (Cation Exchange Capacity), train (vector of {0,1} indicating
#' training (1) and validation (0) samples) and spc (a matrix with absorbance
#' NIR data and band positions as `colnames`).
