...
#' mahalanobis distance to the center of the data greater than 3 (default = `FALSE`).
...
#'
#' If the `rm.outlier` argument is set to `TRUE`, outliers will be removed before
#' running the SELECT algorithm, using the CENTER algorithm of
