...
#' @param rm.outlier logical. If `TRUE`, remove observations with a standardized mahalanobis distance
#' to the center of the data greater than 3 (default = `FALSE`).
...
#'
#' If the `rm.outlier` argument is set to `TRUE`, outliers will be removed before running the SELECT algorithm,
#' using the CENTER algorithm of Shenk and Westerhaus (1991), i.e. samples with a standardized Mahalanobis distance `>3` are removed.
#' @examples
#' data(NIRsoil)
