...
#' @details 
#' The extension of the BUCHI NIRCal files is .nir. These files are used to store Near-Infrared spectra generated by BUCHI N-500 and BUCHI NIRMaster FT-NIR sensors. 
#' See: \url{http://wwww.buchi.com/gb-en/products/nirsolutions/nircal}
