...
#' @param X a `data.frame` or `matrix` to transform.
#' @param type the type of block scaling: 'hard' or 'soft'.
#' @param sigma2 the desired total variance of a block (ie sum of the variances of all variables, default = 1), applicable when `type = 'hard'`.
